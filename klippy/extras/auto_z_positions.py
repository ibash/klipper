...
class AutoZPositions:
    def __init__(self, config):
        ...
        # TODO(ibash) get lift speed from probe
        # TODO(ibash) get distance from config, default to 3
    ...
    def compute_z_positions(self, planes):
        ...
        points = [
            lines[0].intersection(lines[1]), lines[0].intersection(lines[2]),
